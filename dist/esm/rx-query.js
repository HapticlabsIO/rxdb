...
import { sortObject, pluginMissing, overwriteGetterForCaching, now, PROMISE_RESOLVE_FALSE, RXJS_SHARE_REPLAY_DEFAULTS, ensureNotFalsy, areRxDocumentArraysEqual, promiseWait } from "./plugins/utils/index.js";
...
export var RxQueryBase = /*#__PURE__*/function () {
  ...
  _proto._execOverDatabase = async function _execOverDatabase(rerunCount = 0) {
    ...
    var sub = this.collection.eventBulks$.subscribe(() => {
